 ...
 */
abstract class wpdr_AdminPageFramework_NetworkAdmin extends wpdr_AdminPageFramework {
    ...
    public function __construct($sOptionKey = null, $sCallerPath = null, $sCapability = 'manage_network', $sTextDomain = 'admin-page-framework') {
        ...
        $sCallerPath = $sCallerPath ? $sCallerPath : wpdr_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
        $this->oProp = new wpdr_AdminPageFramework_Property_NetworkAdmin($this, $sCallerPath, get_class($this), $sOptionKey, $sCapability, $sTextDomain);
    ...
    static public function getOption($sOptionKey, $asKey = null, $vDefault = null) {
        return wpdr_AdminPageFramework_WPUtility::getSiteOption($sOptionKey, $asKey, $vDefault);
    }
}