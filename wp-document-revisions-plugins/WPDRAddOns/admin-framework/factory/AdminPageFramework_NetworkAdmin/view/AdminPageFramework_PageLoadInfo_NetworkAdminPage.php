 ...
 */
class wpdr_AdminPageFramework_PageLoadInfo_NetworkAdminPage extends wpdr_AdminPageFramework_PageLoadInfo_Base {
    ...
    public static function instantiate($oProp, $oMsg) {
        ...
        self::$_oInstance = new wpdr_AdminPageFramework_PageLoadInfo_NetworkAdminPage($oProp, $oMsg);
