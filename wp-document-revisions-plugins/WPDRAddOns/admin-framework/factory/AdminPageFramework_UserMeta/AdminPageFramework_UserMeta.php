 ...
 */
abstract class wpdr_AdminPageFramework_UserMeta extends wpdr_AdminPageFramework_UserMeta_Controller {
    ...
    public function __construct($sCapability = 'edit_user', $sTextDomain = 'admin-page-framework') {
        $this->oProp = new wpdr_AdminPageFramework_Property_UserMeta($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
