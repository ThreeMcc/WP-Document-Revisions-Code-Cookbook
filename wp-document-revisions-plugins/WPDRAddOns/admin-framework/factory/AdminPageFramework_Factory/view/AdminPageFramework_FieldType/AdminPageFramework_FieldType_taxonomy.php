 ...
 */
class wpdr_AdminPageFramework_FieldType_taxonomy extends wpdr_AdminPageFramework_FieldType_checkbox {
    ...
    protected function setUp() {
        new wpdr_AdminPageFramework_Script_CheckboxSelector;
    }
