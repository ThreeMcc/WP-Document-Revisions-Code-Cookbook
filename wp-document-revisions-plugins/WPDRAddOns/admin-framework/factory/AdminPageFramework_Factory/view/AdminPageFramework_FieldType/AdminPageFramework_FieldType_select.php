 ...
 */
class wpdr_AdminPageFramework_FieldType_select extends wpdr_AdminPageFramework_FieldType {
...
CSSRULES;
    ...
    protected function getField($aField) {
        $_oSelectInput = new wpdr_AdminPageFramework_Input_select($aField['attributes']);
