 ...
 */
class wpdr_AdminPageFramework_FieldType_radio extends wpdr_AdminPageFramework_FieldType {
...
JAVASCRIPTS;
    ...
    private function _getEachRadioButtonOutput(array $aField, $sKey, $sLabel) {
        $_oRadio = new wpdr_AdminPageFramework_Input_radio($aField['attributes']);
