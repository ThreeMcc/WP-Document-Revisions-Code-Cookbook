 ...
 */
abstract class wpdr_AdminPageFramework_FormField_Base extends wpdr_AdminPageFramework_FormOutput {
    public $aField = array();
    ...
    private function _loadScripts($sFieldsType = '') {
        if ('widget' === $sFieldsType && !self::$_bIsLoadedSScripts_Widget) {
            new wpdr_AdminPageFramework_Script_Widget;
        ...
        new wpdr_AdminPageFramework_Script_Utility;
        new wpdr_AdminPageFramework_Script_OptionStorage;
        new wpdr_AdminPageFramework_Script_AttributeUpdator;
        new wpdr_AdminPageFramework_Script_RepeatableField($this->oMsg);
        new wpdr_AdminPageFramework_Script_Sortable;
        new wpdr_AdminPageFramework_Script_RegisterCallback;
    }
