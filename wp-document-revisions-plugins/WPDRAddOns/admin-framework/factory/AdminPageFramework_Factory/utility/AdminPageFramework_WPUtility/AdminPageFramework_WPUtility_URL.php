 ...
 */
class wpdr_AdminPageFramework_WPUtility_URL extends wpdr_AdminPageFramework_Utility {
    ...
    static public function getQueryAdminURL($aAddingQueries = array(), $aRemovingQueryKeys = array(), $sSubjectURL = '') {
        $_sAdminURL = is_network_admin() ? network_admin_url(wpdr_AdminPageFramework_WPUtility_Page::getPageNow()) : admin_url(wpdr_AdminPageFramework_WPUtility_Page::getPageNow());
    ...
    static public function getSRCFromPath($sFilePath) {
        ...
        $sRelativePath = wpdr_AdminPageFramework_Utility::getRelativePath(ABSPATH, $sFilePath);
