 ...
 */
abstract class wpdr_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sCapability, $sTextDomain, $sFieldsType) {
        ...
        $GLOBALS['awpdr_AdminPageFramework'] = isset($GLOBALS['awpdr_AdminPageFramework']) && is_array($GLOBALS['awpdr_AdminPageFramework']) ? $GLOBALS['awpdr_AdminPageFramework'] : array('aFieldFlags' => array());
    ...
    static public function _setLibraryData() {
        self::$_aLibraryData = array('sName' => wpdr_AdminPageFramework_Registry::NAME, 'sURI' => wpdr_AdminPageFramework_Registry::URI, 'sScriptName' => wpdr_AdminPageFramework_Registry::NAME, 'sLibraryName' => wpdr_AdminPageFramework_Registry::NAME, 'sLibraryURI' => wpdr_AdminPageFramework_Registry::URI, 'sPluginName' => '', 'sPluginURI' => '', 'sThemeName' => '', 'sThemeURI' => '', 'sVersion' => wpdr_AdminPageFramework_Registry::getVersion(), 'sDescription' => wpdr_AdminPageFramework_Registry::DESCRIPTION, 'sAuthor' => wpdr_AdminPageFramework_Registry::AUTHOR, 'sAuthorURI' => wpdr_AdminPageFramework_Registry::AUTHOR_URI, 'sTextDomain' => wpdr_AdminPageFramework_Registry::TEXT_DOMAIN, 'sDomainPath' => wpdr_AdminPageFramework_Registry::TEXT_DOMAIN_PATH, 'sNetwork' => '', '_sitewide' => '',);
    ...
    public function __get($sName) {
        if ('aScriptInfo' === $sName) {
            $this->sCallerPath = $this->sCallerPath ? $this->sCallerPath : wpdr_AdminPageFramework_Utility::getCallerScriptPath(__FILE__);
