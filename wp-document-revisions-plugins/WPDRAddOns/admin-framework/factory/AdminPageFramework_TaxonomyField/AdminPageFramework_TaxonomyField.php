 ...
 */
abstract class wpdr_AdminPageFramework_TaxonomyField extends wpdr_AdminPageFramework_TaxonomyField_Controller {
    ...
    function __construct($asTaxonomySlug, $sOptionKey = '', $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $this->oProp = new wpdr_AdminPageFramework_Property_TaxonomyField($this, get_class($this), $sCapability, $sTextDomain, self::$_sFieldsType);
