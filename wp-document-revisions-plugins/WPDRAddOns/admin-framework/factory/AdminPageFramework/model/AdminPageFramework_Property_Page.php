 ...
 */
class wpdr_AdminPageFramework_Property_Page extends wpdr_AdminPageFramework_Property_Base {
    ...
    public function __construct($oCaller, $sCallerPath, $sClassName, $sOptionKey, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework') {
        ...
        $GLOBALS['awpdr_AdminPageFramework']['aPageClasses'] = isset($GLOBALS['awpdr_AdminPageFramework']['aPageClasses']) && is_array($GLOBALS['awpdr_AdminPageFramework']['aPageClasses']) ? $GLOBALS['awpdr_AdminPageFramework']['aPageClasses'] : array();
        $GLOBALS['awpdr_AdminPageFramework']['aPageClasses'][$sClassName] = $oCaller;
