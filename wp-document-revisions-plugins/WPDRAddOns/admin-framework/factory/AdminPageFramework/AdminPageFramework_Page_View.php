 ...
 */
abstract class wpdr_AdminPageFramework_Page_View extends wpdr_AdminPageFramework_Page_View_MetaBox {
    ...
    private function _getFormOutput($sPageSlug) {
        ...
        $_oFieldsTable = new wpdr_AdminPageFramework_FormTable($this->oProp->aFieldTypeDefinitions, $this->aFieldErrors, $this->oMsg);
