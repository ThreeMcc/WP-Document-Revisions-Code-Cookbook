 ...
 */
abstract class wpdr_AdminPageFramework_Form_Model_Import extends wpdr_AdminPageFramework_Router {
    protected function _importOptions($aStoredOptions, $sPageSlug, $sTabSlug) {
        $_oImport = new wpdr_AdminPageFramework_ImportOptions($_FILES['__import'], $_POST['__import']);
