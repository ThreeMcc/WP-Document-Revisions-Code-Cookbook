 ...
 */
abstract class wpdr_AdminPageFramework_Page_View_MetaBox extends wpdr_AdminPageFramework_Page_Model {
    ...
    private function _isMetaBoxAdded($sPageSlug = '') {
        if (!isset($GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses']) || !is_array($GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses'])) {
            return false;
        }
        ...
        foreach ($GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses'] as $sClassName => $oMetaBox) {
    ...
    public function _replyToAddMetaboxScript() {
        if (isset($GLOBALS['awpdr_AdminPageFramework']['bAddedMetaBoxScript']) && $GLOBALS['awpdr_AdminPageFramework']['bAddedMetaBoxScript']) {
            return;
        }
        $GLOBALS['awpdr_AdminPageFramework']['bAddedMetaBoxScript'] = true;
