 ...
 */
abstract class wpdr_AdminPageFramework_Form_Model_Export extends wpdr_AdminPageFramework_Form_Model_Import {
    protected function _exportOptions($mData, $sPageSlug, $sTabSlug) {
        $_oExport = new wpdr_AdminPageFramework_ExportOptions($_POST['__export'], $this->oProp->sClassName);
