 ...
 */
class wpdr_AdminPageFramework_Property_MetaBox_Page extends wpdr_AdminPageFramework_Property_MetaBox {
    ...
    function __construct($oCaller, $sClassName, $sCapability = 'manage_options', $sTextDomain = 'admin-page-framework', $sFieldsType = 'page_meta_box') {
        ...
        $GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses'] = isset($GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses']) && is_array($GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses']) ? $GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses'] : array();
        $GLOBALS['awpdr_AdminPageFramework']['aMetaBoxForPagesClasses'][$sClassName] = $oCaller;
    }
    ...
    private function _getOwnerObjectOfPage($sPageSlug) {
        if (!isset($GLOBALS['awpdr_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        if (!is_array($GLOBALS['awpdr_AdminPageFramework']['aPageClasses'])) {
            return null;
        }
        foreach ($GLOBALS['awpdr_AdminPageFramework']['aPageClasses'] as $__oClass) {
