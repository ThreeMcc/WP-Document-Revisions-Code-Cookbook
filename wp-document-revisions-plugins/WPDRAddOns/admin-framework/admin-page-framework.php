...
abstract class wpdr_AdminPageFramework_Registry_Base {
    const VERSION = '3.5.6';
...
final class wpdr_AdminPageFramework_Registry extends wpdr_AdminPageFramework_Registry_Base {
    ...
    static public function setUp($sFilePath = __FILE__) {
        ...
        self::$sAutoLoaderPath = isset(self::$aClassFiles['wpdr_AdminPageFramework_RegisterClasses']) ? self::$aClassFiles['wpdr_AdminPageFramework_RegisterClasses'] : '';
        self::$bIsMinifiedVersion = class_exists('wpdr_AdminPageFramework_MinifiedVersionHeader');
    }
...
final class wpdr_AdminPageFramework_Bootstrap {
    public function __construct($sLibraryPath = __FILE__) {
        if (!$this->_isLoadable()) {
            return;
        }
        wpdr_AdminPageFramework_Registry::setUp($sLibraryPath);
        if (wpdr_AdminPageFramework_Registry::$bIsMinifiedVersion) {
            return;
        }
        include (wpdr_AdminPageFramework_Registry::$sAutoLoaderPath);
        new wpdr_AdminPageFramework_RegisterClasses(empty(wpdr_AdminPageFramework_Registry::$aClassFiles) ? wpdr_AdminPageFramework_Registry::$sDirPath : '', array('exclude_class_names' => array('wpdr_AdminPageFramework_MinifiedVersionHeader', 'wpdr_AdminPageFramework_BeautifiedVersionHeader',),), wpdr_AdminPageFramework_Registry::$aClassFiles);
        wpdr_AdminPageFramework_Registry::$bIsDevelopmentVersion = class_exists('wpdr_AdminPageFramework_InclusionClassFilesHeader');
    }
...
new wpdr_AdminPageFramework_Bootstrap(__FILE__);