 ...
 */
abstract class wpdr_AdminPageFramework_PluginBootstrap {
    public $sFilePath;
    public $bIsAdmin;
    public $sHookPrefix;
    ...
    protected function _registerClasses() {
        if (!class_exists('wpdr_AdminPageFramework_RegisterClasses')) {
            return;
        }
        new wpdr_AdminPageFramework_RegisterClasses($this->getScanningDirs(), array(), $this->getClasses());
    }
